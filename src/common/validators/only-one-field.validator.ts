            ...
            validator: {
                ...
                defaultMessage(args: ValidationArguments) {
                    ...
                    if (definedFields.length < 1) {
                        return 'At least one field (role, color or isVisible) must be provided';
                    } else if (definedFields.length > 1) {
                        return 'You can update either role, color or isVisible, but not multiple fields at the same time';
                    }
